...
abstract class PlatformARView {
  ...
  Widget build(
      ...
      @required List<String> imageMarkers});
...
createManagers(
  ...
  arViewCreatedCallback(
      ARSessionManager(id, context, planeDetectionConfig, imageMarkers ?? []),
      ARObjectManager(id),
      ARAnchorManager(id),
      ARLocationManager());
}
...
class AndroidARView implements PlatformARView {
  ...
  late List<String>? _imageMarkers;
  ...
  Widget build(
      ...
      ARViewCreatedCallback? arViewCreatedCallback,
      PlaneDetectionConfig? planeDetectionConfig,
      List<String> imageMarkers = const []}) {
    _context = context;
...
class ARView extends StatefulWidget {
  ...
  /// List of image markers to be detected by the AR view
      ...
      case (PermissionStatus.granted):
        {
          return Column(children: [
            ...
            Expanded(
              ...
              imageMarkers: widget.imageMarkers,
            ))
          ]);
        }
