...
/// An [ARAnchor] attached to a tracked image
class ARImageAnchor extends ARAnchor {
  ...
  static ARImageAnchor fromJson(Map<String, dynamic> json) =>
      aRImageAnchorFromJson(json);

  @override
  Map<String, dynamic> toJson() => aRImageAnchorToJson(this);
}

/// Serializes an [ARImageAnchor]
ARImageAnchor aRImageAnchorFromJson(Map<String, dynamic> json) {
...
/// Serializes an [ARImageAnchor]
Map<String, dynamic> aRImageAnchorToJson(ARImageAnchor instance) {
  return <String, dynamic>{
    'type': instance.type.index,
    'transformation': MatrixConverter().toJson(instance.transformation),
